...
import neblio-api
from neblio-api.models.get_transaction_info_response import GetTransactionInfoResponse  # noqa: E501
...
class TestGetTransactionInfoResponse(unittest.TestCase):
    ...
    def testGetTransactionInfoResponse(self):
        ...
        # model = neblio-api.models.get_transaction_info_response.GetTransactionInfoResponse()  # noqa: E501
        pass
